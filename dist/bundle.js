...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log('3+5 = ' + _math2.default.add(3, 5)); //Import whole module

	console.log('5-3 = ' + (0, _math.subtract)(5, 2));
	console.log('3*5 = ' + _math2.default.multiply(3, 5));
	console.log('5/3 = ' + _math2.default.divide(5, 3));

	//ES6 stuff
	var lis = (0, _jquery2.default)('ul.list li');
	(0, _from2.default)(lis).forEach(function (li) {
	  console.log(li.innerHTML);
	});

	var array = [2, 3, 4, 10, 12];
	//finds first match
	console.log(array.find(function (x) {
	  return x < 10;
	}));
	...
	var calcCircle = function calcCircle(x) {
	  var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : PI;
